...
A trained-agent comparison (GRPO via [`train_grpo_colab.ipynb`](train_grpo_colab.ipynb)) sits on top of this baseline. To regenerate the plots:

```bash
cd ai_response_eval_env
python train_and_plot.py --episodes 20
```
